...
4. Install appropriate database adapter and libraries
...
5. Run **Jet Bridge** with the command line as shown below:
...
6. You will see **Jet Admin** token in the console output which you should later enter on **Project Create page**. If you want to display **Jet Admin** token manually, use the following command:
